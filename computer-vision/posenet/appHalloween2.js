...
async function loadAndPredict() {
    ...
    function drawPose(pose) {
        ...
        ctx.fillStyle = 'orange'; // Here you change the color of the circle
        ...
        pose.keypoints.forEach((point,index) => {
            ...
            if ((point.score > 0.5 && nosePoint.includes(point.part))) {
                ctx.beginPath();
                ctx.arc(point.position.x, point.position.y-30, 100, 0, Math.PI); // radius = 5 here
                ctx.stroke();
